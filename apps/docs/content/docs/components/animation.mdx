...
| `onAnimationEnd` | `AnimationEventHandler<HTMLDivElement>` | - | Callback when animation completes |
| `onAnimationStart` | `AnimationEventHandler<HTMLDivElement>` | - | Callback when animation starts |
