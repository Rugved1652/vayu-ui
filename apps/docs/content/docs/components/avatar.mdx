...
| **Avatar.Group**    | Container for stacking multiple avatars with overflow              |
...
| Avatar.Group         | `group`  | `aria-label="{count} users"`, `aria-live="polite"`      |
...
4. **Group overflow**: Screen readers announce total count and overflow count
