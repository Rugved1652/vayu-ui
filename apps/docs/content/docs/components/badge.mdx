...
| :--- | :--- | :--- | :--- |
| `variant` | `'primary' \| 'neutral' \| 'outline' \| 'destructive' \| 'success' \| 'warning' \| 'info'` | `'primary'` | Visual style variant |
| `size` | `'sm' \| 'md' \| 'lg'` | `'md'` | Size of the badge |
| `interactive` | `boolean` | `false` | Enables hover/click styles and keyboard interaction |
| `className` | `string` | - | Additional CSS classes |

## Accessibility

- Full keyboard navigation support (Enter/Space to activate interactive badges)
- Proper ARIA `role="button"` when interactive
