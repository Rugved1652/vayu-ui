...
```bash
npx vayu-ui-cli@latest add breadcrumb
```
...
- `BreadcrumbLink` provides a visible focus ring (`focus-visible:ring-2`) and meets Accessible minimum target size (24x24px) via `py-2` padding
