---
title: Menubar
description: A fully accessible, portal-based menubar component with nested menus, keyboard navigation, and dark mode support.
---
...
<Tabs items={['Preview', 'Code']}>
  <Tab value="Preview">
    <div className="flex w-full justify-center p-8 bg-neutral-100 dark:bg-neutral-900 rounded-lg">
      <MenubarDemo />
    </div>
  </Tab>
  <Tab value="Code">
    ...
    import { File, Save, Printer } from "lucide-react";

    export default function MenubarExample() {
      return (
        <Menubar>
          <Menubar.Menu trigger="File">
            <Menubar.Item icon={<File size={14} />}>New File</Menubar.Item>
            <Menubar.Item icon={<Save size={14} />}>Save</Menubar.Item>
            <Menubar.Separator />
            <Menubar.Item icon={<Printer size={14} />}>Print</Menubar.Item>
          </Menubar.Menu>
...
The Menubar uses the compound component pattern. All subcomponents are namespaced under `Menubar`:

| Component | Description |
| :--- | :--- |
| `Menubar` | Root container component |
| `Menubar.Menu` | Top-level menu with trigger |
| `Menubar.SubMenu` | Nested submenu within a menu |
| `Menubar.Item` | Standard menu item |
| `Menubar.Separator` | Visual divider between items |
| `Menubar.Label` | Non-interactive section label |
| `Menubar.CheckboxItem` | Toggleable checkbox item |
...
| :--- | :--- | :--- | :--- |
| `orientation` | `"horizontal" \| "vertical"` | `"horizontal"` | Layout direction of the menubar |
...
| Prop | Type | Default | Description |
| :--- | :--- | :--- | :--- |
| `trigger` | `ReactNode` | **Required** | Menu trigger button content |
...
| Prop | Type | Default | Description |
| :--- | :--- | :--- | :--- |
| `trigger` | `ReactNode` | **Required** | Submenu trigger content |
...
- **Keyboard Navigation**: Full arrow key navigation between menus and items
- **ARIA Roles**: Proper `menubar`, `menu`, `menuitem`, `menuitemcheckbox`, `menuitemradio` roles
- `aria-haspopup`, `aria-expanded`, and `aria-checked` states
- Visible focus indicators with `focus-visible:ring-2`
- Screen reader labels for keyboard shortcuts
- `Escape` key closes all menus
- Respects `prefers-reduced-motion` for animations

## Source Code

```tsx title="packages/ui/src/components/ui/menubar.tsx"
"use client";
import React, {
    createContext,
    useContext,
