...
<RadioGroup label="Payment Method" variant="card" color="success">
  <RadioGroup.Item
    value="card"
    label="Credit Card"
...
| `color`       | `"primary" \| "success" \| "warning" \| "error" \| "info"` | `"primary"` | Color theme. |
...
- Screen reader compatible labels via native radio inputs
- Respects `prefers-reduced-motion` for transitions
- Error states properly announced via `role="alert"`
