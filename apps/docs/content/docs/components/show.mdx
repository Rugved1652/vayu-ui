...
```bash
npx vayu-ui-cli@latest add show
```
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tab value="Code">
    ```tsx
    import { Show, Match, Case, Default } from "@/components/ui/show"
...
- **`<Match>` / `<Case>` / `<Default>`** — evaluates cases in order, renders first match
...
| :-------- | :---------- | :---------- | :----------------------------------- |
| `Match`   | `children`  | `ReactNode` | Must contain `Case` and/or `Default` |
