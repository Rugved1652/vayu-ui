---
title: Sidebar
description: A responsive sidebar navigation component with collapsible state and nested menus.
---
            ...
            <SidebarContent>
              <SidebarMenu>
                <SidebarMenuGroup label="Main">
                  <SidebarMenuItem icon={<Home />} active>Home</SidebarMenuItem>
                  <SidebarMenuItem icon={<User />}>Profile</SidebarMenuItem>
...
The wrapper component that manages the sidebar state.
...
A navigational item within the sidebar.
...
| badge | `string \| number` | - | Optional badge to display next to the label. |
| href | `string` | - | The URL to navigate to. |
| subItems | `Array<{ label: string, href?: string, active?: boolean }>` | - | Nested menu items. |
...
| children | `ReactNode` | - | helper for the group content. |
