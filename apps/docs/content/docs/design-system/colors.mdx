...
<Tabs items={['Light Mode', 'Dark Mode', 'Usage']}>
  <Tab value="Light Mode">
    <div className="p-6 rounded-lg border border-border" style={{ backgroundColor: '#fafafa' }}>
      <p style={{ color: '#18181b' }}>Canvas is a soft off-white (#fafafa)</p>
      <p className="text-sm mt-2" style={{ color: '#71717a' }}>Easier on the eyes than pure white</p>
    </div>
  </Tab>
  <Tab value="Dark Mode">
    <div className="p-6 rounded-lg border border-border" style={{ backgroundColor: '#09090b' }}>
      <p style={{ color: '#fafafa' }}>Canvas is a rich near-black (#09090b)</p>
      <p className="text-sm mt-2" style={{ color: '#a1a1aa' }}>Not pure black for eye comfort</p>
    </div>
  </Tab>
  <Tab value="Usage">
    ```tsx
...
<Tabs items={['Light Mode', 'Dark Mode', 'Usage']}>
  <Tab value="Light Mode">
    <div className="p-6 rounded-lg shadow-surface" style={{ backgroundColor: '#fff' }}>
      <p style={{ color: '#18181b' }}>Surface is crisp white (#fff)</p>
      <p className="text-sm mt-2" style={{ color: '#71717a' }}>Creates clear separation from canvas</p>
    </div>
  </Tab>
  <Tab value="Dark Mode">
    <div className="p-6 rounded-lg shadow-surface" style={{ backgroundColor: '#18181b' }}>
      <p style={{ color: '#fafafa' }}>Surface is elevated (#18181b)</p>
      <p className="text-sm mt-2" style={{ color: '#a1a1aa' }}>Lighter than canvas for depth</p>
    </div>
  </Tab>
  <Tab value="Usage">
    ```tsx
...
<Tabs items={['Light Mode', 'Dark Mode', 'Usage']}>
  <Tab value="Light Mode">
    <div className="p-6 rounded-lg" style={{ backgroundColor: '#f4f4f5' }}>
      <p style={{ color: '#18181b' }}>Sidebar is neutral gray (#f4f4f5)</p>
      <p className="text-sm mt-2" style={{ color: '#71717a' }}>Subtle difference from canvas</p>
    </div>
  </Tab>
  <Tab value="Dark Mode">
    <div className="p-6 rounded-lg" style={{ backgroundColor: '#0a0a0a' }}>
      <p style={{ color: '#fafafa' }}>Sidebar is deeper black (#0a0a0a)</p>
      <p className="text-sm mt-2" style={{ color: '#a1a1aa' }}>Darker than canvas for contrast</p>
    </div>
  </Tab>
  <Tab value="Usage">
    ```tsx
...
<Tabs items={['Light Mode', 'Dark Mode', 'Usage']}>
  <Tab value="Light Mode">
    <div className="p-6 rounded-lg shadow-elevated" style={{ backgroundColor: '#fff' }}>
      <p style={{ color: '#18181b' }}>Elevated is white (#fff)</p>
      <p className="text-sm mt-2" style={{ color: '#71717a' }}>Same as surface, but with stronger shadow</p>
    </div>
  </Tab>
  <Tab value="Dark Mode">
    <div className="p-6 rounded-lg shadow-elevated" style={{ backgroundColor: '#27272a' }}>
      <p style={{ color: '#fafafa' }}>Elevated is lightest layer (#27272a)</p>
      <p className="text-sm mt-2" style={{ color: '#a1a1aa' }}>Stands out from all other layers</p>
    </div>
  </Tab>
  <Tab value="Usage">
    ```tsx
...
<Tabs items={['Preview', 'Light Mode', 'Dark Mode', 'Usage']}>
  ...
  <Tab value="Light Mode">
    <div className="flex gap-4 items-center">
      <div className="w-12 h-12 rounded-lg flex items-center justify-center text-brand-content" style={{ backgroundColor: '#6366f1' }}>
        Aa
      </div>
      <div>
        <p className="font-medium">Indigo (#6366f1)</p>
  ...
  <Tab value="Dark Mode">
    <div className="flex gap-4 items-center">
      <div className="w-12 h-12 rounded-lg flex items-center justify-center text-brand-content" style={{ backgroundColor: '#818cf8' }}>
        Aa
      </div>
      <div>
        <p className="font-medium">Lighter Indigo (#818cf8)</p>
