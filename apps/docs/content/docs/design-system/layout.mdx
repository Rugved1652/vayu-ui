...
Each layer uses a paired token — one for the background, one for the text on top of it:

| Layer        | Background Token | Text Token              |
| :----------- | :--------------- | :---------------------- |
| **Canvas**   | `bg-canvas`      | `text-canvas-content`   |
| **Sidebar**  | `bg-sidebar`     | `text-sidebar-content`  |
| **Surface**  | `bg-surface`     | `text-surface-content`  |
| **Elevated** | `bg-elevated`    | `text-elevated-content` |
...
<Tabs items={['Example', 'Code']}>
  <Tab value="Example">
    <div className="p-8 rounded-lg bg-canvas">
      <div className="text-canvas-content mb-4">This entire area represents the canvas layer.</div>
      <div className="text-muted-content text-sm">
  ...
  <Tab value="Example">
    <div className="bg-canvas p-6 rounded-lg">
      <div className="bg-surface text-surface-content p-4 rounded-surface shadow-surface mb-4">
        ...
        <div className="text-sm text-muted-content">This card sits on the canvas.</div>
      </div>
      <div className="bg-surface text-surface-content p-4 rounded-surface shadow-surface">
        ...
        <div className="text-sm text-muted-content">Multiple surfaces create visual separation.</div>
      </div>
    </div>
  </Tab>
  <Tab value="Code">
...
<Tabs items={['Example', 'Code']}>
  <Tab value="Example">
    <div className="relative bg-canvas p-8 min-h-64 rounded-lg">
      <div className="bg-surface p-4 flex item-center justify-center  rounded-surface">
        <div className="text-muted-content"> lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod.</div>
      </div>
      ...
      <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
        <div className="bg-elevated text-elevated-content rounded-overlay shadow-elevated p-6 max-w-sm">
          ...
          <div className="text-sm text-muted-content mb-4">This modal floats above all other content.</div>
...
<Tabs items={['Light Mode', 'Dark Mode']}>
  <Tab value="Light Mode">
    <div className="space-y-4">
      <div className="p-4 rounded-lg bg-canvas text-canvas-content">
        <div className="font-medium mb-2">Canvas</div>
        <div className="text-sm text-muted-content">Foundation background layer</div>
      </div>
      <div className="p-4 rounded-lg bg-surface text-surface-content">
        <div className="font-medium mb-2">Surface</div>
        <div className="text-sm text-muted-content">Elevated from canvas</div>
      </div>
      <div className="p-4 rounded-lg bg-sidebar text-sidebar-content">
        <div className="font-medium mb-2">Sidebar</div>
        <div className="text-sm text-muted-content">Navigation areas</div>
      </div>
    </div>
  </Tab>
  <Tab value="Dark Mode">
