...
description: Enforce React Hook Form + Zod + TanStack Query mutation patterns for validated forms.
---
...
```bash
npx skills add Rugved1652/vayu-ui/react-hook-form-zod-validation
```
