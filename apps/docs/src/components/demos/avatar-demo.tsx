        ...
        <div className="w-full max-w-2xl not-prose space-y-8">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex items-end gap-6 flex-wrap">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs!">Small</Typography.P>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <Avatar size="medium" username="Medium User">
                            <Avatar.Initials username="Medium User" />
                        </Avatar>
                        <Typography.P variant="secondary" className="text-xs!">Medium</Typography.P>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <Avatar size="large" username="Large User">
                            <Avatar.Initials username="Large User" />
                        </Avatar>
                        <Typography.P variant="secondary" className="text-xs!">Large</Typography.P>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        <Avatar size="xlarge" username="XL User">
                            <Avatar.Initials username="XL User" />
                        </Avatar>
                        <Typography.P variant="secondary" className="text-xs!">Extra Large</Typography.P>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-8">
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs! font-medium!">Image</Typography.P>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs! font-medium!">Initials</Typography.P>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs! font-medium!">Fallback</Typography.P>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-8">
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs!">Online</Typography.P>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs!">Away</Typography.P>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs!">Busy</Typography.P>
                    </div>
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs!">Offline</Typography.P>
                    </div>
                </div>
            </div>
                ...
                <div className="flex flex-wrap gap-8 items-center">
                    <div className="flex flex-col items-center gap-2">
                        <Avatar
                            size="large"
                            username="Click Me"
                            onClick={() => setClickedAvatar("Click Me")}
                        >
                            <Avatar.Initials username="Click Me" />
                        </Avatar>
                        <Typography.P variant="secondary" className="text-xs!">Button</Typography.P>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-2">
                        ...
                        <Typography.P variant="secondary" className="text-xs!">With Status</Typography.P>
                    </div>
                </div>
            </div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-wrap gap-4 items-center">
                    <Button variant="secondary" size="medium" onClick={() => setClickedAvatar("Button Avatar")}>
