'use client';
import { Button, Status, Typography } from 'vayu-ui';
...
export default function ButtonDemo() {
  ...
  return (
    <div className="flex flex-col gap-4 not-prose w-full justify-center items-center">
      <Typography.H5>Button Example</Typography.H5>
