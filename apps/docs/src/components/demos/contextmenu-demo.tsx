    ...
    return (
        <div className="not-prose flex flex-col gap-8 w-full max-w-md">
            ...
            <div className="text-xs font-secondary text-ground-500 dark:text-ground-400 space-y-1 p-4 bg-ground-50 dark:bg-ground-900 rounded-lg border border-ground-200 dark:border-ground-800">
                ...
                <p>Show Bookmarks: <span className="font-mono text-primary-600 dark:text-primary-400">{showBookmarks ? 'true' : 'false'}</span></p>
                <p>Show URLs: <span className="font-mono text-primary-600 dark:text-primary-400">{showUrls ? 'true' : 'false'}</span></p>
                <p>Assignee: <span className="font-mono text-primary-600 dark:text-primary-400">{person}</span></p>
            </div>
        </div>
    );
}