  ...
  return (
    <div className="w-full max-w-lg not-prose">
      ...
      <div className="flex flex-col items-center gap-8 w-full">
        ...
        {/* No Margin */}
        <div className="flex flex-col items-center gap-2">
          <p className="text-xs font-secondary text-ground-500 dark:text-ground-400">No Margin</p>
          <QRCode
            value="https://vayu-ui.com"
            includeMargin={false}
        ...
        {/* Empty State */}
        <div className="flex flex-col items-center gap-2">
          <p className="text-xs font-secondary text-ground-500 dark:text-ground-400">Empty State</p>
          <QRCode value="" />
        </div>
      </div>
    </div>
