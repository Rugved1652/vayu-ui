...
import { RoleProvider, RoleGuard, RequireAuth, useRoles } from 'vayu-ui';
      ...
      <RoleProvider roles={activeRoles} permissions={permissions}>
        <div className="flex flex-col gap-4">
          ...
          <RoleGuard
            ...
            fallback={
              <Panel color="red">
                🔒 <strong>Content Editor</strong> — requires <code>admin</code> or{' '}
                <code>editor</code>
              </Panel>
            }
          >
          ...
          <RoleGuard
            ...
            fallback={
              <Panel color="red">
                🔒 <strong>Order Actions</strong> — requires <code>orders:write</code> permission
              </Panel>
            }
          >
            <Panel color="green">
          ...
          <RoleGuard
            ...
            fallback={
              <Panel color="red">
                🔒 <strong>Members Only</strong> — <code>guest</code> role is denied
              </Panel>
            }
          >
            <Panel color="green">
...
function Panel({ color, children }: { color: 'green' | 'red'; children: React.ReactNode }) {
  return (
    <div
...
function HookDemo() {
  ...
  return (
    <div className="p-4 rounded-lg bg-ground-50 dark:bg-ground-900 border border-ground-200 dark:border-ground-800 text-sm">
      ...
      <p className="text-ground-600 dark:text-ground-400">
        hasRole(&quot;admin&quot;): <code>{hasRole('admin') ? 'true ✅' : 'false ❌'}</code>
      </p>
    </div>
  );
}
