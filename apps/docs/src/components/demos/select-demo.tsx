            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="grid gap-6">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="mt-2 text-sm text-muted-foreground">
                                Selected: <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">{String(basicValue)}</code>
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        <CardHeader
                            title="Multi Select"
                            action={<Badge variant="muted">Tags</Badge>}
                        />
                        <CardContent>
                            ...
                            <p className="mt-2 text-sm text-muted-foreground">
                                Selected: <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">{JSON.stringify(multiValue)}</code>
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="mt-2 text-sm text-muted-foreground">
                                Selected: <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">{String(asyncValue ?? "none")}</code>
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="mt-2 text-sm text-muted-foreground">
                                Selected: <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">{String(createableValue ?? "none")}</code>
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            ...
                            <p className="mt-2 text-sm text-muted-foreground">
                                Selected: <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">{JSON.stringify(multiCreateableValue)}</code>
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border-primary/50">
                        ...
                        <CardContent>
                            ...
                            <p className="mt-2 text-sm text-muted-foreground">
                                Selected: <code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">{String(combinedValue ?? "none")}</code>
                            </p>
                        </CardContent>
                    </Card>
