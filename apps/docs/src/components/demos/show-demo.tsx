  ...
  return (
    <div className="flex flex-col not-prose gap-10 w-full max-w-md">
      ...
      <div className="flex flex-col gap-3">
        <p className="text-xs font-secondary text-ground-500 dark:text-ground-400">Show / Hide</p>
        <button
      ...
      {/* ── Switch / Case ── */}
      <div className="flex flex-col gap-3">
        <p className="text-xs font-secondary text-ground-500 dark:text-ground-400">Switch / Case</p>
