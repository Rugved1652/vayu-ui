...
export default function TextInputDemo() {
  ...
  return (
    <div className="w-full max-w-md not-prose">
      <Typography.H2 variant="primary">TextInput Examples</Typography.H2>
      ...
      <div className="flex flex-col gap-8 mt-6">
        ...
        <section>
          ...
          <TextInput value={bioValue} onChange={setBioValue}>
        ...
        <section>
          ...
          <div className="flex flex-col gap-4">
            <TextInput value={formValue} onChange={setFormValue}>
