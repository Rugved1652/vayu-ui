...
export function TimepickerBasicDemo() {
  ...
  return (
    <Timepicker value={time} onValueChange={handleValueChange} placeholder="Select time">
      <Timepicker.Trigger />
      <Timepicker.Content>
        <Timepicker.TimeGrid />
        <Timepicker.Footer />
...
export function TimepickerDisabledStateDemo() {
  return (
    <Timepicker disabled defaultValue={{ hour: 14, minute: 30 }} label="Disabled Timepicker">
      <Timepicker.Trigger />
    </Timepicker>
  );
}
...
export function TimepickerWithLabelDemo() {
  ...
  return (
    <Timepicker value={time} onValueChange={handleValueChange} label="Meeting Time">
      <Timepicker.Trigger />
      <Timepicker.Content>
        <Timepicker.TimeGrid />
        <Timepicker.Footer />
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-xs text-muted-content">
        Note: This demo uses a mock Controller. In production, use react-hook-form&apos;s Controller
        component.
      </p>
    </div>
  );
...
export function TimepickerCompleteDemo() {
  ...
  return (
    <div className="space-y-8">
      {/* Basic 12h */}
      <div>
        <h4 className="text-sm font-medium mb-2 text-surface-content">Basic (12h format)</h4>
        <Timepicker value={time} onValueChange={handleTimeChange} placeholder="Select time">
          <Timepicker.Trigger />
          <Timepicker.Content>
            <Timepicker.TimeGrid />
            <Timepicker.Footer />
      ...
      {/* 24h format */}
      <div>
        <h4 className="text-sm font-medium mb-2 text-surface-content">24-Hour Format</h4>
        <Timepicker
          value={time}
      ...
      {/* Time Range */}
      <div>
        <h4 className="text-sm font-medium mb-2 text-surface-content">Time Range</h4>
        <Timepicker
          value={range}
