    ...
    <div className="p-6 border rounded-lg bg-card text-card-foreground shadow-sm w-full flex flex-col items-center gap-6">
      <div className="text-center space-y-2">
        ...
        <div className="flex gap-4 justify-center py-4">
          <div
            className={`flex flex-col items-center gap-2 p-4 rounded-lg border transition-colors ${isDesktop ? 'bg-primary/20 border-primary' : 'bg-muted border-transparent opacity-50'}`}
          >
          ...
          <div
            className={`flex flex-col items-center gap-2 p-4 rounded-lg border transition-colors ${isTablet ? 'bg-primary/20 border-primary' : 'bg-muted border-transparent opacity-50'}`}
          >
          ...
          <div
            className={`flex flex-col items-center gap-2 p-4 rounded-lg border transition-colors ${isMobile ? 'bg-primary/20 border-primary' : 'bg-muted border-transparent opacity-50'}`}
          >
