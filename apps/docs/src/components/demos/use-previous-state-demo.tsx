            ...
            <div className="flex flex-col gap-5">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-xs text-muted-foreground">
                        Previous: <code className="bg-muted px-1 py-0.5 rounded">{prevCount ?? "undefined"}</code>
                    </p>
                </div>
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex gap-1.5 flex-wrap">
                        {names.map((n) => (
                            <button
                                key={n}
                                onClick={() => setName(n)}
                                className={`px-2.5 py-1 rounded-md text-xs font-medium transition-colors ${name === n
                    ...
                    <p className="text-xs text-muted-foreground">
                        ...
                        {" → "}
                        Previous: <code className="bg-muted px-1 py-0.5 rounded">{prevName ?? "undefined"}</code>
                    </p>
                </div>
            </div>
        </div>
