        ...
        <div className="p-6 border rounded-lg bg-card text-card-foreground shadow-sm w-full max-w-md mx-auto flex flex-col gap-6">
            ...
            <div className="grid grid-cols-1 gap-4">
                <div className="p-3 bg-muted/20 rounded border">
                    <span className="text-xs text-muted-foreground uppercase tracking-widest block mb-1">Real-time Value</span>
                ...
                <div className="p-3 bg-primary/10 rounded border border-primary/20">
                    <span className="text-xs text-primary/80 uppercase tracking-widest block mb-1">Throttled Value (1000ms)</span>
