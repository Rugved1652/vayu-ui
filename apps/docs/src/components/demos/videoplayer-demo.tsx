...
export default function VideoPlayerDemo() {
  return (
    <div className="not-prose flex flex-col gap-10 w-full max-w-2xl">
      ...
      {/* ── Minimal ── */}
      <div>
        <p className="text-xs font-secondary text-ground-500 dark:text-ground-400 mb-3">Minimal</p>
        <VideoPlayer.Root autoHideControls={false} className="rounded-xl overflow-hidden">
          <VideoPlayer.Video
