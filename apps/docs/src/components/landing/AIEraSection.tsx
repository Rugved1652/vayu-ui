  ...
  return (
    <section className="relative isolate overflow-hidden bg-linear-to-b from-surface via-canvas to-surface dark:from-canvas dark:via-surface dark:to-canvas px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        ...
        {/* Glowing orbs */}
        <div
          className="absolute top-1/4 right-[20%] animate-pulse"
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-primary text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1]">
            <span className="text-canvas-content">Built for the</span>
          ...
          <p className="mt-6 text-lg sm:text-xl font-secondary text-surface-content max-w-2xl mx-auto leading-relaxed">
            Vayu UI aligns with modern AI workflows — structured, predictable, and designed to
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-4xl mx-auto mb-16">
          {capabilities.map((item, index) => (
            ...
            >
              <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-purple-500/10 to-lime-500/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-slow" />

              <div className="relative flex items-start gap-4 p-6 rounded-2xl border border-border/50 bg-elevated/80 dark:bg-surface/50 backdrop-blur-surface transition-all duration-medium hover:border-border hover:shadow-elevated hover:-translate-y-1">
                {/* Icon */}
                <div className="shrink-0 flex h-12 w-12 items-center justify-center rounded-overlay bg-linear-to-br from-purple-500/10 to-lime-500/5 dark:from-purple-500/5 dark:to-lime-500/3">
                  <item.icon className="h-6 w-6 text-purple-600 dark:text-purple-400" />
                </div>

                {/* Content */}
                <div className="flex-1 min-w-0">
                  <h3 className="font-primary text-lg font-semibold text-canvas-content mb-1">
                    {item.title}
                  </h3>
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="relative rounded-3xl border border-border/50 bg-white/50 dark:bg-neutral-900/30 backdrop-blur-surface p-8 sm:p-12">
            {/* Workflow header */}
            <div className="flex items-center justify-center gap-4 mb-8">
              ...
              <ArrowRight className="w-5 h-5 text-muted-content" />
            ...
            {/* Description */}
            <p className="text-center font-secondary text-surface-content leading-relaxed max-w-2xl mx-auto">
              AI agents read the structured documentation, understand component patterns, and
              generate consistent, production-ready code that integrates seamlessly with your
              existing Vayu UI codebase.
            </p>
            ...
            <div className="mt-8 text-center">
              <Link
                href="/docs"
                className="group relative inline-flex items-center gap-2 rounded-control bg-linear-to-r from-violet-600 to-purple-600 dark:from-violet-500 dark:to-purple-500 px-6 py-3 text-sm font-semibold text-white transition-all duration-fast hover:scale-105 active:scale-[0.98] overflow-hidden"
              >
                <span className="absolute inset-0 bg-linear-to-r from-violet-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-fast" />
                <span className="relative z-10 flex items-center gap-2">
                  Explore AI Integration
                  <ArrowRight className="w-4 h-4 transition-transform duration-fast group-hover:translate-x-1" />
                </span>
                <span className="absolute inset-0 blur-xl bg-violet-500/50 opacity-0 group-hover:opacity-100 transition-opacity duration-fast" />
              </Link>
            </div>
          </div>
        </div>
