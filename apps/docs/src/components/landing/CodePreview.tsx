  ...
  return (
    <section className="relative isolate overflow-hidden bg-canvas px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute top-[60%] right-[10%] animate-float"
        ...
        {/* Floating icons */}
        <div
          className="absolute top-1/6 right-[15%] animate-float"
        ...
        {/* Glowing orbs */}
        <div
          className="absolute top-1/3 left-[30%] animate-pulse"
        ...
        <div
          className="absolute bottom-1/3 right-[25%] animate-pulse"
      ...
      <div className="mx-auto max-w-5xl">
        ...
        <div className="relative group">
          {/* Glow effect */}
          <div className="absolute -inset-1 rounded-2xl bg-linear-to-r from-lime-500/20 via-emerald-500/10 to-cyan-500/20 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-slow" />

          <div className="relative rounded-2xl border border-border overflow-hidden shadow-elevated bg-neutral-950">
            {/* Editor chrome */}
            <div className="flex items-center justify-between px-4 py-3 bg-neutral-900 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <span className="text-xs font-tertiary text-muted-content">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-control text-xs font-medium text-muted-content hover:text-canvas-content hover:bg-neutral-800 transition-all duration-fast"
              >
                {copied ? (
                  <>
            ...
            {/* Editor footer */}
            <div className="flex items-center justify-between px-4 py-2 bg-neutral-900 border-t border-border text-xs text-muted-content">
          ...
          {[
            {
              ...
              description: 'Consistent import paths across all components',
            },
            {
            ...
            },
            {
              ...
              description: 'Code that explains itself to humans and AI',
            },
          ].map((feature) => (
            <div key={feature.title} className="text-center p-4">
              <h3 className="font-primary text-base font-semibold text-canvas-content mb-1">
                {feature.title}
              </h3>
              <p className="font-secondary text-sm text-surface-content">{feature.description}</p>
            </div>
          ))}
        </div>
