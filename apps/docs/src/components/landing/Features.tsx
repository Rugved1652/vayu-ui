    ...
    return (
        <section className="relative isolate overflow-hidden bg-white dark:bg-neutral-950 px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
                ...
                {/* Floating icons */}
                <div className="absolute top-1/4 left-[8%] animate-float" style={{ animationDuration: '7s' }}>
                ...
                <div className="absolute top-[60%] right-[6%] animate-float" style={{ animationDuration: '9s', animationDelay: '2s' }}>
                    <div className="relative group">
                ...
                <div className="absolute bottom-1/3 left-[12%] animate-float" style={{ animationDuration: '11s', animationDelay: '1s' }}>
                    <div className="relative group">
                    ...
                    {features.map((feature, index) => (
                        ...
                        >
                            ...
                            <div className="relative h-full rounded-2xl border border-neutral-200/50 dark:border-neutral-800/50 bg-white/80 dark:bg-neutral-900/50 backdrop-blur-sm p-6 transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-lg hover:-translate-y-1">
                                ...
                                {/* Content */}
                                <h3 className="font-primary text-lg font-semibold text-neutral-900 dark:text-white mb-2">
                                    {feature.title}
                                </h3>
                                ...
                                {/* Hover arrow */}
                                <div className="mt-4 flex items-center text-sm font-medium text-lime-600 dark:text-lime-400 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                                    Learn more
