...
const particles = [
  ...
  { width: 4, height: 4, top: 82, left: 35, opacity: 0.5, duration: 11.8, delay: 1.2 },
  { width: 3, height: 5, top: 27, left: 78, opacity: 0.4, duration: 14.1, delay: 0.9 },
  ...
  { width: 2, height: 3, top: 52, left: 32, opacity: 0.5, duration: 12.8, delay: 2.3 },
  ...
  { width: 5, height: 3, top: 85, left: 25, opacity: 0.4, duration: 9.2, delay: 2.5 },
  ...
  { width: 4, height: 3, top: 18, left: 35, opacity: 0.5, duration: 11.8, delay: 2.1 },
  ...
  return (
    <section className="relative isolate overflow-hidden bg-linear-to-b from-surface via-canvas to-surface dark:from-canvas dark:via-surface dark:to-canvas px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        ...
        {/* Floating icons */}
        <div
          className="absolute top-1/6 left-[15%] animate-float"
        ...
        <div
          className="absolute bottom-1/6 right-[15%] animate-float"
        ...
        <div
          className="absolute bottom-1/4 left-[20%] animate-pulse"
      ...
      <div className="mx-auto max-w-4xl">
        ...
        <div className="relative">
          ...
          <div className="relative rounded-3xl border border-lime-200/50 dark:border-lime-900/30 bg-linear-to-br from-lime-50/80 via-white/90 to-emerald-50/80 dark:from-lime-950/40 dark:via-neutral-900/90 dark:to-emerald-950/40 backdrop-blur-surface p-12 sm:p-16 text-center overflow-hidden">
            ...
            {/* Headline */}
            <h2 className="font-primary text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1] text-canvas-content">
              Stop Fighting
            ...
            {/* Subtext */}
            <p className="mt-6 text-lg sm:text-xl font-secondary text-surface-content max-w-xl mx-auto leading-relaxed">
            ...
            <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link
                href="/docs"
                className="group relative inline-flex items-center gap-2 rounded-overlay bg-linear-to-r from-lime-600 to-emerald-600 dark:from-lime-500 dark:to-emerald-500 px-8 py-4 text-base font-semibold text-white transition-all duration-fast hover:scale-105 active:scale-[0.98] overflow-hidden shadow-elevated shadow-lime-500/25"
              >
                ...
                <span className="relative z-10 flex items-center gap-2">
                  ...
                  <ArrowRight className="w-5 h-5 transition-transform duration-fast group-hover:translate-x-1" />
                </span>
              ...
              <Link
                ...
                target="_blank"
                className="group relative inline-flex items-center gap-2 rounded-overlay border-2 border-border px-8 py-4 text-base font-semibold text-surface-content transition-all duration-fast hover:border-border hover:text-canvas-content hover:scale-105 active:scale-[0.98]"
              >
                <span className="absolute inset-0 bg-surface opacity-0 group-hover:opacity-50 transition-opacity duration-fast rounded-control" />
            ...
            {/* Trust signals */}
            <div className="mt-12 flex flex-wrap items-center justify-center gap-6 text-muted-content">
        ...
        {/* Bottom tagline */}
        <p className="mt-8 text-center font-secondary text-sm text-muted-content">
          Your AI tools will love Vayu UI.{' '}
          <span className="text-lime-600 dark:text-lime-400">
            Give them the structure they deserve.
          </span>
        </p>
      </div>

      {/* Footer / Copyright */}
      <footer className="relative mt-16 pt-8 border-t border-border/50">
        <div className="mx-auto max-w-4xl">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="font-primary text-lg font-semibold text-canvas-content">
                Vayu UI
              </span>
            </div>

            {/* Copyright */}
            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-6 text-sm text-muted-content">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="https://github.com"
                target="_blank"
                className="text-muted-content hover:text-surface-content transition-colors"
              >
