...
export function Hero() {
  return (
    <section className="relative isolate flex flex-col items-center justify-center overflow-hidden bg-canvas px-6 pt-32 pb-20 sm:pt-40 sm:pb-28 lg:px-8 min-h-[90vh]">
      {/* Background */}
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        ...
        >
          <svg
            ...
            height="92"
            viewBox="0 0 80 92"
            className="text-lime-500/20 dark:text-lime-400/10"
          >
        ...
        <div
          className="absolute top-1/2 left-[15%] animate-float"
        ...
        >
          <svg
            ...
            height="58"
            viewBox="0 0 50 58"
            className="text-cyan-500/20 dark:text-cyan-400/10"
          >
        ...
        {/* DNA helix effect */}
        <div
          className="absolute top-1/3 right-[5%] space-y-2 animate-float"
        ...
        <div
          className="absolute top-1/4 left-[8%] animate-float opacity-30 dark:opacity-20"
        ...
        <div
          className="absolute bottom-1/3 right-[12%] animate-float opacity-30 dark:opacity-20"
        ...
        <div
          className="absolute top-1/8 left-[25%] animate-float"
        ...
        <div
          className="absolute top-1/3 right-[15%] animate-float"
        ...
        <div
          className="absolute top-[15%] right-[25%] animate-float"
        ...
        <div
          className="absolute bottom-[40%] left-[5%] animate-float"
        ...
        <div className="absolute inset-0 bg-linear-to-b from-transparent via-transparent to-canvas/50" />

        {/* Decorative SVG wave */}
        <svg
          className="absolute bottom-0 left-0 right-0 h-32 text-surface"
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        ...
        <h1 className="font-primary text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight leading-[1.08] text-canvas-content">
          Build{' '}
          ...
          UI with{' '}
          <span className="relative inline-block">
            <span className="relative z-10 text-lime-600 dark:text-lime-400">Vayu UI</span>
          </span>
        </h1>

        {/* Subheading */}
        <p className="mt-6 text-lg sm:text-xl font-secondary font-medium text-surface-content tracking-wide">
          MCP Server, Knowledge Base for NotebookLM & LLM txt files.
        </p>

        {/* Supporting text */}
        <p className="mt-4 text-base sm:text-lg font-secondary text-muted-content max-w-2xl mx-auto leading-relaxed">
          Production-ready components designed for AI coding agents. Accessible, performant, and
          fully customizable.
        </p>
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <Link
            ...
            target="_blank"
            className="group relative inline-flex items-center gap-2 rounded-lg border-2 border-border px-6 py-3 text-sm font-semibold text-neutral-700 dark:text-neutral-300 transition-all duration-fast hover:border-border hover:text-canvas-content hover:scale-105 active:scale-[0.98] overflow-hidden"
          >
            <span className="absolute inset-0 bg-surface opacity-0 group-hover:opacity-50 transition-opacity duration-fast" />
        ...
        <div className="mt-12 flex flex-col items-center gap-3">
          <div className="flex items-center gap-6 text-muted-content">
