    ...
    return (
        <section className="relative isolate overflow-hidden bg-gradient-to-b from-neutral-50 via-white to-neutral-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
                ...
                <div
                    className="absolute top-1/4 left-1/4 w-[450px] h-[450px] rounded-full bg-gradient-to-br from-lime-400/15 via-emerald-400/10 to-transparent dark:from-lime-500/8 dark:via-emerald-500/5 blur-[100px] animate-morph-blob"
                ...
                <div className="absolute bottom-1/3 left-[8%] animate-pulse" style={{ animationDuration: '5s', animationDelay: '2s' }}>
                    <div className="w-40 h-40 rounded-full bg-gradient-to-br from-cyan-500/10 to-teal-500/5 blur-2xl" />
                </div>
            ...
            <div className="mx-auto max-w-6xl">
                ...
                <div className="relative">
                    ...
                    <div className="hidden lg:block absolute top-24 left-[16.67%] right-[16.67%] h-0.5">
                        <div className="h-full bg-gradient-to-r from-lime-500/0 via-lime-500/50 to-cyan-500/0" />
                        <div className="absolute inset-0 bg-gradient-to-r from-lime-500/0 via-lime-500/50 to-cyan-500/0 blur-sm" />
                    </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-8">
                        {steps.map((step, index) => (
                            <div key={step.number} className="relative group">
                                {/* Card glow */}
                                <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-lime-500/10 to-cyan-500/5 blur-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                ...
                                <div className="relative flex flex-col items-center text-center p-8 rounded-3xl border border-neutral-200/50 dark:border-neutral-800/50 bg-white/80 dark:bg-neutral-900/50 backdrop-blur-sm transition-all duration-300 hover:border-neutral-300 dark:hover:border-neutral-700 hover:shadow-xl hover:-translate-y-2">
                                    ...
                                    <div className="absolute -top-4 left-1/2 -translate-x-1/2">
                                        <div className={`flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r ${step.gradient} text-white text-xs font-bold shadow-lg`}>
                                            {step.number}
                                        </div>
                                    </div>
                                    ...
                                    <div className={`mt-4 mb-6 relative`}>
                                        <div className={`absolute inset-0 blur-2xl bg-gradient-to-r ${step.gradient} opacity-30 group-hover:opacity-50 transition-opacity duration-300`} />
                                        <div className={`relative flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br ${step.gradient} p-0.5`}>
                                    ...
                                    {step.code && (
                                        <div className="mt-6 w-full">
                                            <div className="relative group/code">
                                                <div className="absolute inset-0 rounded-xl bg-gradient-to-r from-neutral-900 to-neutral-800 blur-xl opacity-20" />
