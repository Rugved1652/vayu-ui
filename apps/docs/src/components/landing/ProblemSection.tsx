    ...
    return (
        <section className="relative isolate overflow-hidden bg-gradient-to-b from-neutral-50 via-white to-neutral-50 dark:from-neutral-950 dark:via-neutral-900 dark:to-neutral-950 px-6 py-24 sm:py-32 lg:px-8">
            ...
            <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
                ...
                <div
                    className="absolute top-1/4 -left-20 w-[500px] h-[500px] rounded-full bg-gradient-to-br from-red-400/15 via-orange-400/10 to-transparent dark:from-red-500/10 dark:via-orange-500/5 blur-[100px] animate-morph-blob"
                    style={{ animationDuration: '25s' }}
                />
                <div
                    className="absolute bottom-1/4 -right-20 w-[400px] h-[400px] rounded-full bg-gradient-to-bl from-amber-400/15 via-yellow-400/10 to-transparent dark:from-amber-500/10 dark:via-yellow-500/5 blur-[80px] animate-morph-blob"
                    style={{ animationDuration: '30s', animationDelay: '5s' }}
                />
                <div
                    className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full bg-gradient-to-r from-lime-400/10 via-emerald-400/5 to-transparent dark:from-lime-500/5 dark:via-emerald-500/3 blur-[120px] animate-morph-blob"
                ...
                <div className="absolute top-1/4 right-[25%] animate-pulse" style={{ animationDuration: '4s' }}>
                    <div className="w-24 h-24 rounded-full bg-gradient-to-br from-red-500/10 to-orange-500/5 blur-2xl" />
                </div>

                <div className="absolute bottom-1/4 left-[25%] animate-pulse" style={{ animationDuration: '5s', animationDelay: '1s' }}>
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-amber-500/10 to-yellow-500/5 blur-2xl" />
                </div>
            ...
            <div className="mx-auto max-w-6xl">
                ...
                <div className="text-center mb-16">
                    ...
                    <h2 className="font-primary text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1]">
                        ...
                        <span className="relative inline-block mt-2">
                            <span className="relative z-10 bg-gradient-to-r from-red-600 via-orange-500 to-amber-500 bg-clip-text text-transparent dark:from-red-400 dark:via-orange-400 dark:to-amber-400">
                                But Can It Ship It?
                            </span>
                            <span className="absolute inset-0 blur-2xl bg-gradient-to-r from-red-600/20 via-orange-500/20 to-amber-500/20 dark:from-red-400/10 dark:via-orange-400/10 dark:to-amber-400/10" />
                        </span>
                    </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
                    ...
                    <div className="group relative">
                        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-red-500/20 to-orange-500/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    ...
                    {/* Card 2 - Duplicated */}
                    <div className="group relative">
                        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-orange-500/20 to-amber-500/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                    ...
                    <div className="group relative">
                        <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-amber-500/20 to-yellow-500/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                ...
                <div className="relative">
                    ...
                    <div className="absolute inset-x-0 top-0 flex items-center justify-center">
                        <div className="flex items-center gap-4">
                            <div className="h-px w-16 sm:w-32 bg-gradient-to-r from-transparent via-red-500/30 to-transparent" />
                            ...
                            <div className="h-px w-16 sm:w-32 bg-gradient-to-r from-transparent via-lime-500/30 to-transparent" />
                        </div>
                    </div>

                    {/* Solution card */}
                    <div className="mt-16 relative">
                        <div className="absolute inset-0 rounded-3xl bg-gradient-to-br from-lime-500/10 via-emerald-500/5 to-cyan-500/10 blur-3xl" />
                        <div className="relative rounded-3xl border border-lime-200/50 dark:border-lime-900/30 bg-gradient-to-br from-lime-50/50 via-white/80 to-emerald-50/50 dark:from-lime-950/30 dark:via-neutral-900/80 dark:to-emerald-950/30 backdrop-blur-sm p-8 sm:p-12">
                            {/* Decorative elements */}
                            ...
                            <div className="max-w-3xl mx-auto text-center">
                                ...
                                <h3 className="font-primary text-2xl sm:text-3xl lg:text-4xl font-bold text-neutral-900 dark:text-white mb-4">
                                    <span className="bg-gradient-to-r from-lime-600 via-emerald-500 to-cyan-500 bg-clip-text text-transparent dark:from-lime-400 dark:via-emerald-400 dark:to-cyan-400">
                                        Vayu UI
                                    </span>{" "}
