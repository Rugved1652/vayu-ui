...
export function ProblemSection() {
  return (
    <section className="relative isolate overflow-hidden bg-linear-to-b from-surface via-canvas to-surface dark:from-canvas dark:via-surface dark:to-canvas px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="absolute inset-0 -z-10 pointer-events-none overflow-hidden">
        ...
        <div
          className="absolute top-1/6 left-[10%] animate-float"
        ...
        <div
          className="absolute bottom-1/3 left-[5%] animate-float"
        ...
        <div
          className="absolute top-[60%] right-[12%] animate-float"
        ...
        {/* Glowing orbs */}
        <div
          className="absolute top-1/4 right-[25%] animate-pulse"
        ...
        <div
          className="absolute bottom-1/4 left-[25%] animate-pulse"
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className="font-primary text-4xl sm:text-5xl lg:text-6xl font-bold tracking-tight leading-[1.1]">
            <span className="text-canvas-content">AI Can Generate Code.</span>
          ...
          <p className="mt-6 text-lg sm:text-xl font-secondary text-surface-content max-w-2xl mx-auto leading-relaxed">
            Modern AI tools generate components fast — but without structure, consistency, and
            system thinking, the output becomes{' '}
            <span className="text-red-600 dark:text-red-400 font-semibold">messy</span>,{' '}
            <span className="text-orange-600 dark:text-orange-400 font-semibold">duplicated</span>,
            and{' '}
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-16">
          ...
          <div className="group relative">
            <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-red-500/20 to-orange-500/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-slow" />
            <div className="relative h-full rounded-2xl border border-red-200/50 dark:border-red-900/30 bg-elevated/80 dark:bg-surface/50 backdrop-blur-surface p-6 transition-all duration-medium hover:border-red-300 dark:hover:border-red-800/50 hover:shadow-elevated">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-overlay bg-red-100 dark:bg-red-500/10">
                  <Puzzle className="h-6 w-6 text-red-600 dark:text-red-400" />
                </div>
                <XCircle className="w-5 h-5 text-red-500" />
              </div>
              <h3 className="font-primary text-xl font-semibold text-canvas-content mb-2">
                Inconsistent Output
              </h3>
              <p className="font-secondary text-surface-content text-sm leading-relaxed">
                Every AI response follows different patterns, naming conventions, and styling
                approaches.
              </p>
            </div>
          </div>
          ...
          {/* Card 2 - Duplicated */}
          <div className="group relative">
            <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-orange-500/20 to-amber-500/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-slow" />
            <div className="relative h-full rounded-2xl border border-orange-200/50 dark:border-orange-900/30 bg-elevated/80 dark:bg-surface/50 backdrop-blur-surface p-6 transition-all duration-medium hover:border-orange-300 dark:hover:border-orange-800/50 hover:shadow-elevated">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-overlay bg-orange-100 dark:bg-orange-500/10">
              ...
              <p className="font-secondary text-surface-content text-sm leading-relaxed">
                AI regenerates similar components instead of reusing existing ones, creating
                technical debt.
              </p>
            </div>
          </div>
          ...
          <div className="group relative">
            <div className="absolute inset-0 rounded-2xl bg-linear-to-br from-amber-500/20 to-yellow-500/10 blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-slow" />
            <div className="relative h-full rounded-2xl border border-amber-200/50 dark:border-amber-900/30 bg-elevated/80 dark:bg-surface/50 backdrop-blur-surface p-6 transition-all duration-medium hover:border-amber-300 dark:hover:border-amber-800/50 hover:shadow-elevated">
              <div className="flex items-center gap-3 mb-4">
                <div className="flex h-12 w-12 items-center justify-center rounded-overlay bg-amber-100 dark:bg-amber-500/10">
        ...
        <div className="relative">
          ...
          <div className="mt-16 relative">
            ...
            <div className="relative rounded-3xl border border-lime-200/50 dark:border-lime-900/30 bg-linear-to-br from-lime-50/50 via-white/80 to-emerald-50/50 dark:from-lime-950/30 dark:via-neutral-900/80 dark:to-emerald-950/30 backdrop-blur-surface p-8 sm:p-12">
              {/* Decorative elements */}
              <div
              ...
              <div className="max-w-3xl mx-auto text-center">
                ...
                <h3 className="font-primary text-2xl sm:text-3xl lg:text-4xl font-bold text-canvas-content mb-4">
                ...
                <p className="text-base sm:text-lg font-secondary text-surface-content leading-relaxed mb-8">
