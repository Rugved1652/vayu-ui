export const accordionRegistry = {
  ...
  ai_summary:
    'Accordion is a compound component for organizing content into collapsible sections. Composed of Accordion.Item, Accordion.Header, and Accordion.Body. Supports single or multiple open panels with animated transitions and full keyboard navigation.',
