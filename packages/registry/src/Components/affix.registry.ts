export const affixRegistry = {
  ...
  description:
    'Pins content to the viewport when scrolling past it. Supports top/bottom positioning, custom scroll containers, and an affixed callback.',
  ai_summary:
    'A sticky positioning component that pins content to the viewport edge (top or bottom) when the user scrolls past it. Uses a placeholder element to prevent layout shift and supports both window and custom container scrolling.',
