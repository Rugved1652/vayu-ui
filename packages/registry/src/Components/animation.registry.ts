export const animationRegistry = {
  ...
  ai_summary:
    'Compound animation component providing 9 entrance animation variants (Fade, Slide, Zoom, Bounce, Flip, Rotate, Roll, JackInTheBox, Hinge) with configurable duration, delay, iteration, and fillMode. Automatically respects prefers-reduced-motion for accessibility.',
  intent: [
  ...
  props: {
    ...
    'Animation.Zoom': [
      { name: 'children', type: 'ReactNode', required: true, description: 'Content to animate' },
      {
        ...
        required: false,
        default: 'medium',
        description: 'Scale intensity of zoom',
      },
      {
        name: 'duration',
        type: '"slower" | "slow" | "normal" | "fast" | "faster"',
    ...
    'Animation.Bounce': [
      { name: 'children', type: 'ReactNode', required: true, description: 'Content to animate' },
      {
        ...
        required: false,
        default: 'medium',
        description: 'Scale intensity of bounce',
      },
      {
        name: 'duration',
        type: '"slower" | "slow" | "normal" | "fast" | "faster"',
    ...
    'Animation.Flip': [
      { name: 'children', type: 'ReactNode', required: true, description: 'Content to animate' },
      {
        ...
        required: false,
        default: 'up',
        description: 'Direction of flip animation',
      },
      {
        name: 'duration',
        type: '"slower" | "slow" | "normal" | "fast" | "faster"',
    ...
    'Animation.Roll': [
      { name: 'children', type: 'ReactNode', required: true, description: 'Content to animate' },
      {
        ...
        required: false,
        default: 'left',
        description: 'Direction of roll animation',
      },
      {
        name: 'duration',
        type: '"slower" | "slow" | "normal" | "fast" | "faster"',
  ...
  variants: [
    {
      name: 'duration',
      values: ['slower', 'slow', 'normal', 'fast', 'faster'],
      default: 'normal',
      description:
        'Animation duration (slower: 2000ms, slow: 1500ms, normal: 1000ms, fast: 700ms, faster: 500ms)',
    },
    {
      name: 'delay',
      ...
      default: 'none',
      description:
        'Delay before animation starts (none: 0ms, short: 150ms, medium: 300ms, long: 500ms)',
    },
    {
      name: 'iteration',
    ...
    },
    {
      ...
      default: 'none',
      description: 'How styles apply before/after animation',
    },
    {
      name: 'direction',
      values: ['up', 'down', 'left', 'right'],
      default: 'varies',
      description: 'Direction for Slide, Flip, and Roll animations',
    },
    {
      name: 'scale',
      values: ['small', 'medium', 'large'],
      default: 'medium',
      description: 'Scale intensity for Zoom and Bounce animations',
    },
  ],
  states: [],
  responsive: {
...
<Animation.Flip direction="left">
  ...
  installation: ['npx vayu-ui init    # Add Theme CSS if not added', 'npx vayu-ui add animation'],
  source: {
