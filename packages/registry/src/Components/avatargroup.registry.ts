export const avatarGroupRegistry = {
  ...
  description:
    'Displays a stack or grid of avatars with overflow handling, showing a count indicator when the number of users exceeds the maximum display limit.',
  ai_summary:
    'AvatarGroup is a display component that renders multiple avatars in either an overlapping stack layout or a grid layout. It automatically handles overflow by showing a +N indicator when users exceed maxDisplay. Integrates with the Avatar component for consistent styling and supports status indicators, interactive click handlers, and full keyboard navigation for accessibility.',
  ...
  props: {
    AvatarGroup: [
      {
        ...
        default: [],
        description:
          'Array of user objects to display as avatars. Each user can have id, src, username, alt, fallback, and status properties.',
      },
      {
        name: 'size',
      ...
      },
      {
        ...
        default: 'stack',
        description:
          'Layout mode: stack creates overlapping avatars, grid displays them in a wrapped row.',
      },
      {
        name: 'spacing',
        ...
        default: 'normal',
        description:
          'Spacing between avatars in stack layout. Negative margin creates overlap. Can be a custom number value.',
      },
      {
        name: 'renderOverflow',
      ...
      },
      {
        ...
        required: false,
        description:
          'Click handler for individual avatars. When provided, avatars become interactive with keyboard support.',
      },
      {
    ...
    UserData: [
      ...
      },
      {
        ...
        required: false,
        description:
          'Fallback text to display when no image is available. Used if username is not provided.',
      },
      {
        name: 'status',
  ...
  variants: [
    ...
    },
    {
      ...
      default: 'stack',
      description:
        'Layout mode: stack creates overlapping avatars with negative margins, grid displays in wrapped row with gap',
    },
    {
      name: 'spacing',
...
<AvatarGroup users={users} />`,
  ...
  installation: ['npx vayu-ui init    # Add Theme CSS if not added', 'npx vayu-ui add avatargroup'],
