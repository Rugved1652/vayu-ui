    ...
    Badge: [
      {
        ...
        default: "primary",
        description:
          "Visual style variant for different semantic purposes",
      },
      {
        name: "size",
        type: "'sm' | 'md' | 'lg'",
      ...
      },
      {
        ...
        required: false,
        description:
          "Makes the badge interactive (renders as button element)",
      },
      {
        name: "onDismiss",
        type: "() => void",
...
>
  Removable Tag
    ...
    },
    {
      ...
      description:
        "Split-button pattern with separate click and dismiss actions",
      code: `import { Badge } from "vayu-ui";
