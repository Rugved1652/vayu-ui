export const breadcrumbRegistry = {
  ...
  description:
    "Displays the path to the current resource using a hierarchy of links, helping users understand their location within the application's navigation structure.",
  ai_summary:
    "A compound navigation component that renders a hierarchical path of links showing the user's current location. Composed of Breadcrumb, BreadcrumbList, BreadcrumbItem, BreadcrumbLink, BreadcrumbPage, BreadcrumbSeparator, and BreadcrumbEllipsis subcomponents.",
  ...
  installation: ['npx vayu-ui init    # Add Theme CSS if not added', 'npx vayu-ui add breadcrumb'],
