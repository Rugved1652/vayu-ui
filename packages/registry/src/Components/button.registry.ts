...
export const buttonRegistry: VayuComponentDoc = {
  ...
  description:
    'An interactive element triggered by a user. A compound component that provides versatile button functionality with multiple variants, sizes, loading states, and optional icon, text, and badge subcomponents.',
  ai_summary:
    'A versatile interactive button component with 5 variants (primary, secondary, outline, ghost, destructive) and 3 sizes (small, medium, large). Compound structure with Icon, Text, and Badge subcomponents. Supports loading states via Status enum, full-width mode, and WCAG 2.2 AA accessibility with proper ARIA attributes.',
  ...
  variants: [
    {
      ...
      default: 'primary',
      description:
        'Visual style: primary (filled, prominent), secondary (subtle gray), outline (border-only), ghost (transparent), destructive (red for dangerous actions)',
    },
    {
      name: 'size',
      ...
      default: 'small',
      description:
        'Size variants: small (36px min-height), medium (40px min-height), large (44px min-height)',
    },
  ],
...
<Button variant="ghost">
  ...
  installation: ['npx vayu-ui init', 'npx vayu-ui add button'],
