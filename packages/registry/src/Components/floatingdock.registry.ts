export const floatingdockRegistry = {
  ...
  design_tokens: {
    used: {
      ...
      border: [
        "border",
        "border-ground-200/50",
        "border-ground-800/50"
      ],
      spacing: [
        "p-3",
        "px-3",
