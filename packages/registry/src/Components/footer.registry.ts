export const footerRegistry = {
  ...
  ai_summary: "Multi-slot footer component with three layout variants (default, centered, minimal). Supports sections, links, social icons, logo, and copyright. Fully accessible with WCAG 2.2 AA compliance. Server Component compatible.",
  ...
  ai_keywords: ["footer", "navigation", "site-footer", "layout", "responsive", "accessibility", "compound", "server-component", "multi-column", "social-links"],
  ...
  variants: [
    {
      ...
      default: "default",
      description: "Layout variant controlling grid structure and alignment. Default: 4-column grid. Centered: single column with centered content. Minimal: 2-column layout."
    }
  ],
