export const modalRegistry = {
  ...
  description: "An accessible dialog overlay component with focus trap, keyboard navigation, and compound component API.",
  ai_summary: "A compound component that renders an accessible modal dialog using React portals with built-in focus trapping, keyboard navigation, scroll lock, and both controlled and uncontrolled state management patterns.",
  ...
  props: {
    ...
    "Modal.Close": [
      ...
      },
      {
        ...
        type: "string",
        required: false,
        description: "Additional CSS classes. When no children provided, renders default X icon button."
      },
      {
        name: "children",
        type: "React.ReactNode",
        required: false,
        description: "Custom close button content. When omitted, renders X icon with aria-label='Close'."
      }
    ]
  },
  ...
  variants: [
    {
      ...
      default: "md",
      description: "Maximum width of the modal panel. sm=28rem, md=32rem, lg=40rem, xl=48rem, full=calc(100vw - 4rem)"
    }
  ],
  ...
  design_tokens: {
    used: {
      ...
      typography: ["text-sm", "text-lg", "font-semibold", "font-medium", "font-primary", "font-secondary"]
    },
    recommended: {
