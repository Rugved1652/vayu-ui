export const navbarRegistry = {
  ...
  description:
    'A responsive, accessible navigation bar with compound components for building flexible navigation layouts. Supports desktop and mobile views with a slide-in mobile menu panel.',
  ai_summary:
    'Compound navigation component with responsive mobile menu, focus trap, keyboard navigation, and WCAG 2.4.3 compliant focus management. Use for site-wide navigation with desktop links and mobile hamburger menu.',
  ...
  props: {
    Navbar: [
      ...
      },
      {
        ...
        default: 'main',
        description:
          'CSS selector for main content element (gets inert attribute when mobile menu is open)',
      },
      {
        name: 'className',
        type: 'string',
  ...
  states: ['default', 'mobileOpen', 'active', 'hover', 'focus'],
  ...
  design_tokens: {
    ...
    recommended: {
      colors: ['bg-white', 'bg-ground-950', 'text-primary-600', 'text-primary-400'],
      radius: ['rounded'],
  ...
  accessibility: {
    ...
    standards: ['WCAG 2.4.3 Focus Order', 'WCAG 2.1.1 Keyboard', 'WCAG 4.1.2 Name, Role, Value'],
    keyboard_support: [
  ...
  installation: ['npx vayu-ui init    # Add Theme CSS if not added', 'npx vayu-ui add navbar'],
