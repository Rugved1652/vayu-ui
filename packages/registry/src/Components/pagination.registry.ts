export const paginationRegistry = {
  ...
  description:
    'A fully accessible pagination component with compound pattern for building flexible navigation interfaces. Supports server-side rendering with Next.js Link integration.',
  ai_summary:
    'Compound pagination component with Root container, Info display, Buttons for page navigation, and Compact variant for mobile. Uses hrefBuilder for URL generation, supports pageRange modes (compact/extended/full), and includes full accessibility support.',
  ...
  composition: {
    root: 'Pagination',
    slots: ['Pagination.Root', 'Pagination.Info', 'Pagination.Buttons', 'Pagination.Compact'],
    structure: [
      'Pagination',
      'Pagination.Root',
      'Pagination.Info',
  ...
  variants: [
    {
      ...
      default: 'compact',
      description:
        'Controls how many page numbers are displayed. Compact shows limited numbers with ellipsis, extended shows more siblings, full shows all pages',
    },
    {
      name: 'layout',
      values: ['full', 'compact'],
      default: 'full',
      description:
        'Full layout uses Pagination.Buttons with page numbers, compact uses Pagination.Compact with only Previous/Next',
    },
  ],

  states: ['default', 'hover', 'focus', 'active/current', 'disabled'],
  ...
  design_tokens: {
    used: {
      ...
      spacing: ['gap-1', 'gap-1.5', 'gap-4', 'px-2.5', 'px-3', 'p-8'],
      typography: [
        'text-sm',
        'font-secondary',
        'font-medium',
    ...
    recommended: {
      colors: ['primary-600', 'primary-500', 'ground-700', 'ground-300'],
      radius: ['rounded'],
...
export default function FullPaginationExample() {
  ...
  accessibility: {
    ...
    standards: ['WCAG 2.2 AA compliant', 'WAI-ARIA Authoring Practices'],
    keyboard_support: [
  ...
  dependencies: {
    icons: ['ChevronLeft', 'ChevronRight', 'ChevronsLeft', 'ChevronsRight', 'MoreHorizontal'],
    utilities: ['cn'],
    components: ['Link'],
  },

  relationships: {
    used_with: ['Table', 'DataGrid', 'List', 'Card'],
    often_inside: ['Card', 'Section', 'Container'],
    often_contains: [],
  },

  related_components: ['Table', 'List'],
  ...
  installation: ['npx vayu-ui init    # Add Theme CSS if not added', 'npx vayu-ui add pagination'],
