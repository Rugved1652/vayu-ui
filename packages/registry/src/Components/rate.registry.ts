export const rateRegistry = {
  ...
  ai_summary: "Compound rating component with keyboard navigation, half-star precision, custom icons, labels, and full accessibility support. Supports controlled/uncontrolled modes with visual feedback states.",
