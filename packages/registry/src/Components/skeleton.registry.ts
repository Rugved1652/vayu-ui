...
export const skeletonRegistry: VayuComponentDoc = {
  ...
  variants: [
    ...
    },
    {
      ...
      default: 'text',
      description:
        'Shape variant for Skeleton.Item: text (full-width lines), circular (round), rectangular (sharp corners), rounded (rounded corners)',
    },
    {
      name: 'size',
      values: ['sm', 'md', 'lg', 'xl'],
