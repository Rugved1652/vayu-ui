export const tabRegistry = {
  ...
  description: "A set of layered sections of content—known as tab panels—that are displayed one at a time. A flexible, headless-style tabbed interface component with full dark/light mode support, controlled/uncontrolled modes, keyboard navigation, and full accessibility (WCAG 2.2 AA).",
  ai_summary: "Compound tabbed interface component with Tabs.List, Tabs.Trigger, and Tabs.Content subcomponents. Supports horizontal/vertical orientations, controlled/uncontrolled state, keyboard navigation, and WCAG 2.2 AA accessibility compliance.",
  ...
  ai_keywords: ["tabs", "tabbed interface", "navigation", "content switching", "tab panels", "tab list", "keyboard navigation", "accessibility"],
