export const tableRegistry = {
  ...
  ai_summary: "Compound table component for displaying tabular data with WCAG 2.2 AA accessibility compliance, sortable columns, selectable rows, and dark mode support.",
  ...
  ai_keywords: ["table", "data", "grid", "sortable", "selectable", "tabular", "rows", "columns", "responsive"],
