...
export const textareaRegistry: VayuComponentDoc = {
  ...
  description:
    'A multi-line text input component with support for labels, validation, and character counting.',
  ai_summary:
    'Compound textarea component with Root, Label, Input, SupportText, ErrorText, and CharCount subcomponents for building accessible multi-line text inputs with validation states.',
  ...
  accessibility: {
    ...
    standards: ['WCAG 2.1 Level AA', 'WAI-ARIA 1.2', 'Section 508'],
    keyboard_support: [
  ...
  installation: ['npx vayu-ui init', 'npx vayu-ui add textarea'],
