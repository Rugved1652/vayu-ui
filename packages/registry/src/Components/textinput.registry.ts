export const textinputRegistry = {
  ...
  description:
    'A flexible and accessible text input component with support for various input types, validation states, and styling variants.',
  ai_summary:
    'Compound text input component with Root, Label, Field, Input, and helper text subcomponents. Supports password, number, and search variants with built-in validation states, character counting, and accessibility features.',
  ...
  responsive: {
    allowed: true,
    patterns: ['Size variants can adapt to viewport', 'Full width by default with w-full utility'],
  },
  ...
  design_tokens: {
    ...
    allowed: {
      colors: ['ground-*', 'primary-*', 'error-*', 'warning-*', 'success-*'],
...
<TextInput.Root validationState="success">
  ...
  accessibility: {
    ...
    standards: ['WCAG 2.2 AA', 'ARIA 1.2'],
    keyboard_support: [
  ...
  dependencies: {
    icons: ['AlertCircle', 'CheckCircle', 'Eye', 'EyeClosed', 'Loader2', 'Search', 'X'],
    utilities: [],
    components: [],
  },

  relationships: {
    used_with: ['Form', 'Button', 'Label'],
    often_inside: ['Form', 'Card', 'Dialog'],
    often_contains: [],
  },
  ...
  installation: ['npx vayu-ui init    # Add Theme CSS if not added', 'npx vayu-ui add textinput'],
