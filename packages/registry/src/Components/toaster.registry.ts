  ...
  props: {
    ...
    ToastOptions: [
      ...
      },
      {
        ...
        default: 5000,
        description:
          "Duration in ms before auto-dismiss. Set to 0 for persistent toasts",
      },
      {
        name: "position",
        type: "ToastPosition",
    ...
    "useToast returns": [
      ...
      },
      {
        ...
        type: "(message: ReactNode, options?) => string",
        description:
          "Shows a loading toast (no auto-dismiss), returns toast ID",
      },
      {
        name: "promise",
        type: "<T>(promise: Promise<T>, messages, options?) => Promise<T>",
        description:
          "Handles loading/success/error states for a promise automatically",
      },
      {
        name: "custom",
  ...
  variants: [
    {
      ...
      description:
        "Visual variant determining icon, colors, and accessibility role",
    },
    {
      name: "position",
      values: [
...
export default function App() {
  ...
  return (
    ...
    },
    {
      ...
      description:
        "Automatically handles loading, success, and error states for async operations",
...
export default function RootLayout({ children }) {
  return (
    ...
    },
    {
      ...
      description:
        "Update a loading toast to success/error when operation completes",
      code: `const toast = useToast();
