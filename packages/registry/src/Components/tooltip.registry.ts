  ...
  props: {
    "Tooltip": [
      ...
      },
      {
        ...
        required: false,
        default: 150,
        description: "Hide delay in milliseconds (time before tooltip disappears after mouse leaves)"
      },
      {
        name: "variant",
      ...
      },
      {
        ...
        required: false,
        default: true,
        description: "Ensures minimum touch target size of 24x24 CSS pixels (WCAG 2.5.8). Set to false for inline text tooltips."
      },
      {
        name: "className",
        type: "string",
