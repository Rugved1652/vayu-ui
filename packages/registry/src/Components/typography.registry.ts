export const typographyRegistry = {
  ...
  description:
    'Text styles and variants for headings, paragraphs, and other text elements with WCAG 2.2 AA compliance.',
  ai_summary:
    'A compound typography component providing semantic text elements (H1-H6, P, Label, Link, Code, CTA) with consistent styling, color variants, and full accessibility support for building readable, accessible interfaces.',
  ...
  design_tokens: {
    used: {
      ...
      spacing: ['px-1.5', 'py-0.5', 'ml-1', 'min-h-11', 'min-w-11'],
      border: [
        'rounded',
        'focus:ring-2',
        'focus:ring-offset-2',
    ...
    recommended: {
      colors: ['text-ground-900', 'text-ground-50'],
...
<Typography.Code codeLang="typescript">
  ...
  installation: ['npx vayu-ui init    # Add Theme CSS if not added', 'npx vayu-ui add typography'],
