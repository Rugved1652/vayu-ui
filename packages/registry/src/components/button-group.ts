...
export const buttonGroupEntry: ComponentRegistryEntry = {
  ...
  tags: ['button', 'group', 'toolbar', 'action', 'segmented', 'layout', 'flex', 'orientation'],
  useCases: [
  ...
  files: [
    {
      ...
      description:
        'Root component that renders a flex container with role="group", CSS-enforced sizing, radius tokens, and z-index focus management',
    },
    {
      name: 'types.ts',
      description: 'TypeScript type definitions for ButtonGroupProps and ButtonGroupRadius union',
    },
    {
      name: 'index.ts',
      description: 'Barrel export file re-exporting the component and all types',
    },
  ],
  ...
  rootProps: [
    ...
    },
    {
      ...
      defaultValue: "'medium'",
      description:
        'Forces uniform padding, font size, and min-height on all child buttons via CSS descendant selectors',
    ...
    },
    {
      ...
      description:
        'Border radius variant using semantic design tokens, applied to the group container and all child buttons',
    ...
    },
    {
      ...
      defaultValue: 'false',
      description:
        'When true, the group stretches to full container width and each child button gets flex-1',
    },
    {
      name: 'children',
    ...
    },
    {
      ...
      required: false,
      description:
        'Accessible label for the button group; essential for screen readers to announce the group purpose',
    },
    {
      ...
      required: false,
      description:
        'ID of an element that labels this button group, as an alternative to aria-label',
    },
  ],
  rendersAs: 'div',
  ...
  states: [
    {
      ...
      defaultValue: 'horizontal',
      description:
        'Controls whether buttons are laid out in a row (flex-row) or column (flex-col).',
    },
    {
      name: 'fullWidth',
      prop: 'fullWidth',
      ...
      defaultValue: 'false',
      description:
        'When true, the group becomes w-full and each child button receives flex-1 to distribute space evenly.',
    },
  ],
  ...
  events: [
    {
      ...
      description:
        'Fired when the group container is clicked; individual button clicks bubble up to this handler',
    },
    {
      name: 'onFocus',
    ...
    attributes: [
      {
        name: 'role="group"',
        description:
          'Applied to the root div to semantically group the child buttons as a related set of controls.',
        managedByComponent: true,
      },
      {
        name: 'aria-label',
        description:
          'Passed through from the aria-label prop to provide an accessible name for the group. Required when there is no visible group heading.',
        managedByComponent: false,
      },
      {
        name: 'aria-labelledby',
        description:
          'Passed through from the aria-labelledby prop to reference an external element that labels the group.',
        managedByComponent: false,
      },
    ],
    keyboardInteractions: [
      {
        key: 'Tab',
        behavior:
          'Moves focus to the first child button (or next focusable element if already inside the group)',
      },
      {
        key: 'Shift+Tab',
  ...
  registryDependencies: [
    {
      slug: 'button',
      reason:
        'ButtonGroup is designed to wrap Button elements; child buttons are required for correct sizing and spacing behavior',
    },
  ],
  ...
  peerComponents: [
    {
      slug: 'button',
      reason:
        'ButtonGroup wraps Button elements — every usage requires at least two Button children',
    },
    {
      slug: 'tooltip',
      reason:
        'Icon-only buttons inside ButtonGroup benefit from tooltips to provide accessible text descriptions on hover',
    },
    {
      slug: 'card',
      reason:
        'Cards frequently contain grouped action buttons (e.g. edit/delete) in headers or footers',
    },
    {
      slug: 'popover',
      reason:
        'Button groups can serve as trigger elements for popover menus with additional actions',
    },
    {
      slug: 'divider',
      reason:
        'Dividers separate distinct button groups visually when multiple groups appear in a toolbar',
    },
  ],
  ...
  examples: [
    {
      ...
      description:
        'Basic horizontal button group with outline variant buttons, the default orientation.',
...
export default function VerticalGroup() {
  return (
    ...
    },
    {
      title: 'Full Width',
      description:
        'Button group that spans the full container width with evenly distributed buttons.',
      code: `import { Button, ButtonGroup } from 'vayu-ui';
...
export default function FullWidthGroup() {
  return (
    ...
    },
    {
      ...
      description:
        'Button group combining outline, secondary, and primary variants for progressive action emphasis.',
      code: `import { Button, ButtonGroup } from 'vayu-ui';
...
export default function IconGroup() {
  return (
    ...
    },
    {
      ...
      description:
        'All four radius options (control, surface, overlay, full) demonstrated side by side.',
      code: `import { Button, ButtonGroup } from 'vayu-ui';
  ...
  doNot: [
    {
      ...
      reason:
        'Without an accessible name, screen readers announce the group role but cannot convey its purpose. Always provide aria-label or aria-labelledby so users understand what the grouped buttons control.',
    },
    {
      ...
      reason:
        'ButtonGroup applies CSS descendant selectors targeting direct <button> children ([&>button]:...) for sizing, radius, and focus management. Non-button children will not receive the enforced styles or proper z-index behavior.',
    },
    {
      ...
      reason:
        'Nesting groups creates confusing semantics for assistive technology and breaks the [&>button] CSS selectors that only target direct child buttons. Use a single flat group or separate groups side by side.',
    },
    {
      ...
      reason:
        'A ButtonGroup with a single child adds unnecessary wrapper markup and semantic noise. Use the Button component directly with its own fullWidth prop instead.',
    },
    {
      ...
      reason:
        'Without a width constraint (e.g. w-fit or a fixed width), a vertical group will stretch to the full container width. Use className="w-fit" to let the column shrink to the widest button.',
    },
  ],
};
