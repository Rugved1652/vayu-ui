  ...
  files: [
    {
      name: 'NavBar.tsx',
      description:
        'Root component with context provider, mobile open state, escape key handler, body scroll lock, and background inert management',
    },
    {
      name: 'NavbarContainer.tsx',
      description: 'Responsive max-width wrapper that centers and pads the navigation content',
    },
    {
      name: 'NavBarBrand.tsx',
      description: 'Brand/logo area rendered as a flex container with gap',
    },
    {
      name: 'NavbarMenuItems.tsx',
      description:
        'Desktop navigation list (NavbarItems) and individual navigation link items (NavbarItem) with active state styling',
    },
    {
      name: 'NavBarActions.tsx',
      description: 'Desktop action buttons area hidden on mobile, rendered as a flex row',
    },
    {
      name: 'NavBarToggle.tsx',
      description:
        'Mobile hamburger/X toggle button with animated icon transitions and ARIA expanded state',
    },
    {
      name: 'NavBarMobileMenu.tsx',
      description:
        'Mobile slide-out panel with backdrop, close button, focus trap, and mobile navigation items (NavbarMobileMenu + NavbarMobileItem)',
    },
    {
      name: 'NavBarSeparator.tsx',
      description: 'Horizontal divider for separating sections within the mobile menu',
    },
    {
      name: 'types.ts',
      description:
        'TypeScript interfaces for all Navbar sub-component props, context value, and injected link props',
    },
    {
      name: 'index.ts',
      description:
  ...
  subComponents: [
    {
      ...
      description:
        'Responsive max-width wrapper that centers content horizontally with configurable breakpoint',
      props: [
        {
          name: 'maxWidth',
    ...
    },
    {
      ...
      description:
        'Brand/logo area rendered as a shrink-0 flex container for logo and company name',
      props: [],
    },
    {
      name: 'Items',
      ...
      description:
        'Desktop navigation list container; hidden on mobile, displayed as a horizontal flex row on md+ breakpoints',
      props: [],
    },
    {
      name: 'Item',
      fileName: 'NavbarMenuItems.tsx',
      description:
        'Individual desktop navigation link with active state styling and aria-current support',
      props: [
        {
          name: 'active',
          type: 'boolean',
          ...
          defaultValue: 'false',
          description:
            'Marks the item as the current page; applies brand styling and aria-current="page"',
        },
        {
          name: 'href',
          type: 'string',
    ...
    },
    {
      ...
      description:
        'Desktop action buttons area; hidden on mobile, displayed as a flex row with gap on md+ breakpoints',
      props: [],
    },
    {
      name: 'Toggle',
      ...
      description:
        'Mobile hamburger/X button with animated three-line icon that toggles the mobile menu',
      props: [],
    },
    {
      name: 'MobileMenu',
      ...
      description:
        'Mobile slide-out panel with backdrop overlay, close button, focus trap, and scrollable content area',
      props: [],
    },
    {
      name: 'MobileItem',
      fileName: 'NavBarMobileMenu.tsx',
      description:
        'Mobile navigation link that closes the menu on click and supports active state styling',
      props: [
        {
          name: 'active',
          type: 'boolean',
  ...
  rootProps: [
    {
      ...
      defaultValue: "'main'",
      description:
        'CSS selector for the main content element that gets set to inert when the mobile menu is open, preventing background interaction',
    },
  ],
  rendersAs: 'nav',
  ...
  states: [
    {
      ...
      defaultValue: 'false',
      description:
        'Controls the mobile menu open/close state. When true: menu slides in, backdrop appears, body scroll is locked, and main content is set to inert. Managed internally via NavbarToggle click.',
    },
  ],
  ...
  events: [
    {
      ...
      signature: '() => void',
      description:
        'Fired when the hamburger/X toggle button is clicked; flips the mobileOpen state between true and false',
    },
    {
      name: 'onClose (MobileMenu)',
      signature: '() => void',
      description:
        'Fired when the mobile menu is closed via backdrop click, close button click, or Escape key. Returns focus to the toggle button.',
    },
    {
      name: 'onClick (MobileItem)',
      signature: '() => void',
      description:
        'Fired when a mobile navigation item is clicked; closes the mobile menu first, then calls the provided onClick handler',
    },
  ],
  ...
  a11y: {
    ...
    attributes: [
      {
        ...
        description:
          'Applied to the root <nav> element to identify the primary navigation landmark',
        managedByComponent: true,
      },
      {
        name: 'aria-expanded',
        description:
          'Applied to the toggle button; reflects the mobile menu open/close state for screen readers',
        managedByComponent: true,
      },
      {
        name: 'aria-controls',
        description:
          'Applied to the toggle button; references the mobile menu panel ID to associate the control with its target',
        managedByComponent: true,
      },
      {
        name: 'aria-label (Toggle)',
        description:
          'Dynamic label on the toggle button: "Open navigation menu" when closed, "Close navigation menu" when open',
        managedByComponent: true,
      },
      {
        name: 'role="dialog"',
        description:
          'Applied to the mobile menu panel to signal a dialog overlay to assistive technology',
        managedByComponent: true,
      },
      {
        name: 'aria-modal="true"',
        description:
          'Applied to the mobile menu panel to indicate that background content is inert while the menu is open',
        managedByComponent: true,
      },
      {
      ...
      },
      {
        ...
        description:
          'Applied to Navbar.Item and Navbar.MobileItem when the active prop is true, indicating the current page to screen readers',
        managedByComponent: true,
      },
    ],
    keyboardInteractions: [
      ...
      },
      {
        key: 'Tab',
        behavior:
          'Moves focus to the next focusable element within the mobile menu (trapped when menu is open)',
      },
      {
        key: 'Shift+Tab',
        behavior:
          'Moves focus to the previous focusable element within the mobile menu (trapped when menu is open)',
      },
    ],
    focusManagement:
  ...
  peerComponents: [
    {
      slug: 'button',
      reason:
        'Buttons are commonly placed in Navbar.Actions for CTAs like "Sign in" and "Get started", and in the mobile menu for mobile CTAs',
    },
    {
      slug: 'typography',
      reason:
        'Typography.H5 or similar headings are used inside Navbar.Brand to render the site name or logo text',
    },
    {
      slug: 'divider',
      reason:
        'Dividers separate navigation items from action buttons in the mobile menu using Navbar.Separator',
    },
    {
      slug: 'avatar',
      reason:
        'Avatars can appear in Navbar.Brand or Navbar.Actions for user profile indicators and account menus',
    },
    {
      slug: 'badge',
      reason:
        'Badges can be used on Navbar.Item elements to indicate notification counts or new feature labels',
    },
  ],
  ...
  examples: [
    {
      ...
      description:
        'A complete responsive navbar with brand, navigation items with active state, action buttons, and a mobile menu.',
  ...
  doNot: [
    {
      ...
      reason:
        'All Navbar sub-components except the root use the Navbar context via useNavbar(). Rendering them outside <Navbar> throws an error: "Navbar compound components must be used inside <Navbar>".',
    },
    {
      ...
      reason:
        'Without Navbar.Toggle, users have no way to open the mobile menu. The toggle button provides aria-expanded, aria-controls, and the click handler that sets mobileOpen to true.',
    },
    {
      ...
      reason:
        'Navbar.Items and Navbar.Actions use "hidden md:flex" — they are invisible below the md breakpoint. Adding mobile content there wastes renders. Use Navbar.MobileMenu for mobile-specific items.',
    },
    {
      ...
      reason:
        'Navbar.Item renders as a Link component. Combining href with a custom onClick can cause race conditions between client-side navigation and your handler. If you need custom click behavior, use a plain element inside the list instead.',
    },
    {
      ...
      reason:
        'Navbar renders as a <nav> element with aria-label="Main navigation". Nesting it inside another <nav> creates a confusing landmark structure for screen readers.',
    },
  ],
};
