  ...
  files: [
    {
      name: 'Tab.tsx',
      description:
        'Root component with context provider, controlled/uncontrolled state management, and compound component wiring',
    },
    {
      name: 'TabsList.tsx',
      description:
        'Tablist container with ARIA role, orientation attribute, and full keyboard navigation (arrow keys, Home, End)',
    },
    {
      name: 'TabsTrigger.tsx',
      description:
        'Tab trigger button with ARIA selected state, roving tabindex, disabled support, and orientation-aware styling',
    },
    {
      name: 'TabsContent.tsx',
      description:
        'Tab panel with ARIA role, auto-focus support, force mount option, and active/inactive state management',
    },
    {
      name: 'hooks.ts',
      description:
        'React context and useTabsContext hook for sharing active tab state across compound sub-components',
    },
    {
      name: 'types.ts',
      description:
        'TypeScript type definitions for TabsOrientation, TabsContextValue, TabsProps, TabsListProps, TabsTriggerProps, and TabsContentProps',
    },
    {
      name: 'index.ts',
      description:
    ...
    {
      name: 'README.md',
      description: 'Component anatomy, use cases, and file structure documentation',
    },
  ],
  ...
  subComponents: [
    {
      ...
      description:
        'Container for tab triggers with ARIA tablist role, orientation-aware keyboard navigation, and accessible labeling via aria-label or aria-labelledby',
      props: [
        {
          name: 'aria-label',
          type: 'string',
        ...
        },
        {
          ...
          required: false,
          description:
            'ID of a visible element that labels the tab list. Alternative to aria-label for when a visible heading labels the tabs.',
        },
        {
          name: 'children',
    ...
    },
    {
      ...
      description:
        'Tab trigger button with ARIA tab role, automatic selected/disabled states, roving tabindex, and orientation-aware styling',
      props: [
        {
          name: 'value',
          type: 'string',
          required: true,
          description:
            'Unique value identifying this tab. Used to match the trigger with its corresponding Tabs.Content panel.',
        },
        {
          name: 'disabled',
          type: 'boolean',
          ...
          defaultValue: 'false',
          description:
            'Disables the tab trigger, removing it from keyboard navigation and preventing activation',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
    ...
    },
    {
      ...
      description:
        'Tab panel with ARIA tabpanel role, auto-focus support, and optional force mounting for preserving state across tab switches',
      props: [
        {
          name: 'value',
          type: 'string',
          required: true,
          description:
            'Unique value matching a Tabs.Trigger value. The panel is visible when this value matches the active tab.',
        },
        {
          name: 'forceMount',
          type: 'boolean',
          ...
          defaultValue: 'false',
          description:
            'When true, the panel stays mounted in the DOM when inactive (hidden via CSS). Useful for preserving component state like form inputs.',
        },
        {
          name: 'children',
          type: 'React.ReactNode',
  ...
  rootProps: [
    {
      ...
      required: false,
      description:
        'Initial active tab value for uncontrolled mode. Used when the component manages its own state internally.',
    },
    {
      name: 'value',
      type: 'string',
      required: false,
      description:
        'Controlled active tab value. When provided, the component becomes controlled and only changes via onValueChange.',
    },
    {
      name: 'onValueChange',
      ...
      required: false,
      description:
        'Callback fired when the active tab changes. Receives the new tab value as a string.',
    },
    {
      name: 'orientation',
      ...
      description:
        'Tab layout direction. Horizontal renders tabs in a row with bottom border; vertical renders tabs in a column with right border.',
    ...
    },
    {
      ...
      defaultValue: 'false',
      description:
        'When true, focus automatically moves to the active tab panel when a new tab is activated.',
    },
    {
      name: 'children',
      type: 'React.ReactNode',
  ...
  states: [
    {
      ...
      defaultValue: "''",
      description:
        'The currently active tab. When a Tabs.Trigger value matches the active state, it renders with brand-colored styling and tabindex=0.',
    },
    {
      name: 'inactive',
      prop: 'value',
      isBoolean: false,
      description:
        'Non-active tabs render with muted styling and tabindex=-1, removing them from the tab order until activated.',
    },
    {
      name: 'disabled',
      prop: 'disabled',
      ...
      defaultValue: 'false',
      description:
        'A disabled Tabs.Trigger cannot be activated by click or keyboard. It is skipped during arrow key navigation and rendered with reduced opacity.',
    },
    {
      name: 'forceMounted',
      prop: 'forceMount',
      ...
      defaultValue: 'false',
      description:
        'When true on Tabs.Content, the panel stays mounted in the DOM but hidden via the HTML hidden attribute when inactive. Preserves component state.',
    },
  ],
  ...
  events: [
    {
      ...
      description:
        'Fired when the active tab changes. Receives the value of the newly activated tab trigger.',
    },
  ],
    ...
    attributes: [
      {
        name: 'role="tablist"',
        description:
          'Applied to Tabs.List to identify it as a tab list container for assistive technology',
        managedByComponent: true,
      },
      {
        name: 'aria-orientation',
        description:
          'Applied to the tablist element, set to "horizontal" or "vertical" to indicate tab navigation direction',
        managedByComponent: true,
      },
      {
        name: 'aria-label / aria-labelledby',
        description:
          'Required accessible name for the tab list. Either aria-label or aria-labelledby must be provided for WCAG compliance.',
        managedByComponent: false,
      },
      {
        name: 'role="tab"',
        description:
          'Applied to each Tabs.Trigger button to identify it as a tab control within the tablist',
        managedByComponent: true,
      },
      {
        name: 'aria-selected',
        description:
          'Applied to each tab trigger, set to true for the active tab and false for inactive tabs',
        managedByComponent: true,
      },
      {
        name: 'aria-controls',
        description:
          'Applied to each tab trigger with value "tabpanel-{value}", linking it to the corresponding panel by ID',
        managedByComponent: true,
      },
      {
        name: 'aria-disabled',
        description:
          'Applied to disabled tab triggers alongside the native disabled attribute for screen reader compatibility',
        managedByComponent: true,
      },
      {
        name: 'role="tabpanel"',
        description:
          'Applied to each Tabs.Content div to identify it as the content panel associated with a tab',
        managedByComponent: true,
      },
      {
        name: 'aria-labelledby',
        description:
          'Applied to each tab panel with value "tab-{value}", linking it back to its corresponding trigger by ID',
        managedByComponent: true,
      },
    ],
    keyboardInteractions: [
      {
        key: 'ArrowRight',
        behavior:
          'In horizontal orientation, moves focus to the next tab trigger (wraps from last to first)',
      },
      {
        key: 'ArrowLeft',
        behavior:
          'In horizontal orientation, moves focus to the previous tab trigger (wraps from first to last)',
      },
      {
        key: 'ArrowDown',
        behavior:
          'In vertical orientation, moves focus to the next tab trigger (wraps from last to first)',
      },
      {
        key: 'ArrowUp',
        behavior:
          'In vertical orientation, moves focus to the previous tab trigger (wraps from first to last)',
      },
      {
        key: 'Home',
  ...
  peerComponents: [
    {
      slug: 'button',
      reason:
        'Action buttons are commonly placed inside tab panels for form submissions, navigation, and contextual actions',
    },
    {
      slug: 'card',
      reason:
        'Tabs are frequently used inside cards to organize card content into switchable sections',
    },
    {
      slug: 'typography',
      reason:
        'Heading and text components are used inside tab panels to structure content hierarchies',
    },
    {
      slug: 'divider',
    ...
    },
    {
      slug: 'badge',
      reason:
        'Badges can be added to tab triggers to indicate notification counts or status on tab sections',
    },
  ],
  ...
  examples: [
    {
      ...
      description:
        'Default horizontal tab layout with two tabs and an accessible label provided via aria-labelledby referencing a heading element.',
...
export default function HorizontalTabsDemo() {
  return (
    ...
    },
    {
      title: 'Vertical Tabs',
      description:
        'Vertical orientation tabs for sidebar-style navigation with aria-label for accessibility.',
      code: `import { Tabs, Typography } from 'vayu-ui';
...
export default function VerticalTabsDemo() {
  return (
    ...
    },
    {
      title: 'Disabled Tab',
      description:
        'Tab with a disabled trigger that cannot be activated by click or keyboard, useful for gating content behind permissions.',
      code: `import { Tabs, Typography } from 'vayu-ui';
...
export default function DisabledTabDemo() {
  return (
    ...
    },
    {
      ...
      description:
        'Multi-tab layout integrating Button components inside tab panels for contextual actions like view, export, save, and reset.',
...
export default function TabsWithActionsDemo() {
  ...
  doNot: [
    ...
    },
    {
      ...
      reason:
        'Each Tabs.Trigger value must match exactly one Tabs.Content value. Mismatched values break the ARIA linkage (aria-controls, aria-labelledby) and leave panels permanently hidden or triggers with no panel.',
    },
    {
      ...
      reason:
        'Do not mix defaultValue (uncontrolled) with value/onValueChange (controlled) on the same Tabs instance. Pick one mode: either let the component manage state with defaultValue, or fully control it with value and onValueChange.',
    },
    {
      ...
      reason:
        'Tabs.List, Tabs.Trigger, and Tabs.Content rely on the TabsContext provided by the root Tabs component. Using them outside Tabs will throw a runtime error: "Tabs compound components must be used within a Tabs component".',
    },
    {
      ...
      reason:
        'Each Tabs.Trigger must have a unique value. Duplicate values cause both triggers to appear active simultaneously, break keyboard navigation (two elements share the same panel), and produce invalid ARIA with duplicate IDs.',
    },
  ],
};
