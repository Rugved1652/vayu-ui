...
- accordion-body.tsx — AccordionBody subcomponent with animated height transitions
- types.ts — TypeScript type definitions for all component props and context
...
- Data tables with expandable rows for additional details
