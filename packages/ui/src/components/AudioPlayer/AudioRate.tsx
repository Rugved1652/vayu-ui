...
import { forwardRef, HTMLAttributes, ButtonHTMLAttributes, useState } from 'react';
import { Popover } from '../Popover';
import { useAudioPlayer } from './Audio';

const RATES = [0.5, 0.75, 1, 1.25, 1.5, 1.75, 2];

export const AudioPlayerRate = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <Popover.Content align="center" side="top" sideOffset={8} className="!p-1 min-w-[80px]">
