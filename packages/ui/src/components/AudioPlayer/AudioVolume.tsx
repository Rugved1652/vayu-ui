...
import { forwardRef, HTMLAttributes, ButtonHTMLAttributes, useState, useEffect } from 'react';
...
export const AudioPlayerVolume = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
