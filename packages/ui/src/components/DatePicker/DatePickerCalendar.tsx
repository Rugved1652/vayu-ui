  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="relative">
              ...
              >
                <span className="min-w-12 text-center">{currentDate.getFullYear()}</span>
                <ChevronDownIcon className="w-3 h-3 text-muted-content" />
              </button>
        ...
        {/* Day Headers */}
        <div className="grid grid-cols-7 mb-2" role="row" aria-label="Days of the week">
          ...
          {days.map((day, index) => {
            const isSelected =
              mode === 'single'
                ...
                : isRangeStart(day, selectedRange) || isRangeEnd(day, selectedRange);
            const isRangeStartDay = isRangeStart(day, selectedRange);
            const isRangeEndDay = isRangeEnd(day, selectedRange);
            const isInRange = mode === 'range' && isDateInRange(day, selectedRange);
            const isHoverRange = isRangeHovered(day, selectedRange, rangeHoverDate);
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  isOtherMonth ? 'text-muted-content/40' : 'text-surface-content',
