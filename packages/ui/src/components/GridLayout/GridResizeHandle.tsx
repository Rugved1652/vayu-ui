  ...
  if (children) {
    return (
      <div
        ...
        className={cn('absolute bottom-0 right-0 z-20 touch-none cursor-se-resize', className)}
      >
        {children}
      </div>
    );
  ...
  return (
    <>
      ...
      {directions.includes('se') && (
        <div className="absolute bottom-1 right-1 z-20 pointer-events-none" aria-hidden="true">
          <svg
            width="10"
            height="10"
            viewBox="0 0 10 10"
