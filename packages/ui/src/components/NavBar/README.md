...
- items.tsx — desktop navigation list + item
- actions.tsx — desktop action buttons area
- toggle.tsx — mobile hamburger/X button
- mobile-menu.tsx — mobile slide panel + mobile item
