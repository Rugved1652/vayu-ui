...
import { TimepickerError, TimepickerFooter } from './TimePickerFooter';
...
const Timepicker = Object.assign(TimepickerRoot, {
  Trigger: TimepickerTrigger as React.ForwardRefExoticComponent<
    TimepickerTriggerProps & React.RefAttributes<HTMLDivElement>
  >,
  Content: TimepickerContent as React.FC<TimepickerContentProps>,
  HourColumn: HourColumn as React.FC<HourColumnProps>,
  MinuteColumn: MinuteColumn as React.FC<MinuteColumnProps>,
  PeriodColumn: PeriodColumn as React.FC<PeriodColumnProps>,
  TimeGrid: TimeGrid as React.FC<TimeGridProps>,
  Footer: TimepickerFooter as React.FC<TimepickerFooterProps>,
  Error: TimepickerError as React.FC<TimepickerErrorProps>,
});
