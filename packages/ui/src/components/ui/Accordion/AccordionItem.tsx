...
export const AccordionItem: React.FC<AccordionItemProps> = ({ children, itemId, className }) => {
  ...
  return (
    <div className={cn('group border-b border-border last:border-b-0', className)}>{children}</div>
  );
};
