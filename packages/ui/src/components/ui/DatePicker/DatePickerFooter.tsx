...
export const DatePickerCalendarFooter = forwardRef<HTMLDivElement, DatePickerCalendarFooterProps>(
  ({ className, ...props }, ref) => {
    const { handleClear, selectedDate, selectedRange, mode, goToToday } = useDatePicker();

    const hasSelection = mode === 'single' ? !!selectedDate : !!selectedRange?.startDate;
