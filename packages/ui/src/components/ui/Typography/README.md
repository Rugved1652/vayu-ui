...
- `code.tsx` — UI: Code component with language declaration
- `link.tsx` — UI: Link component with Next.js routing
- `utils.ts` — Helpers: getVariantClasses
...
- Internal and external links with WCAG-compliant accessibility
