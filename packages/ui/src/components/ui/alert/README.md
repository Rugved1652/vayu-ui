...
- AlertDescription.tsx — UI (description text)
- AlertDismiss.tsx — UI (dismiss button)
- AlertContent.tsx — UI (content wrapper)
- types.ts — types
- index.ts — public API
...
- Compound pattern for flexible alert layouts
