...
export const AudioPlayerPlaylist = forwardRef<
  HTMLDivElement,
...
type AudioPlayerTrackProps = Track &
  HTMLAttributes<HTMLDivElement> & { 'data-index'?: number };

export const AudioPlayerTrack = forwardRef<
  HTMLDivElement,
  AudioPlayerTrackProps
>(
  (
    {
      src,
    ...
    return (
      ...
      >
        ...
        <div className="flex flex-col flex-1 min-w-0">
          ...
          {artist && (
            <span className="truncate text-xs text-muted-content">
              {artist}
            </span>
          )}
        </div>
