...
- link.tsx — Clickable navigation link
- page.tsx — Current page indicator
- separator.tsx — Visual separator between items
- ellipsis.tsx — Overflow indicator
...
- Accessible path indicator with ARIA labels
