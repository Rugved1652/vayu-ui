...
export const CheckboxDescription = forwardRef<HTMLParagraphElement, CheckboxDescriptionProps>(
  ({ className, children, ...props }, ref) => {
    ...
    return (
      <p
        ref={ref}
        id={descriptionId}
        className={clsx('text-sm text-muted-content', disabled && 'opacity-50', className)}
        {...props}
      >
        {children}
      </p>
