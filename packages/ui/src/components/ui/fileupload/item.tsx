...
const Item: React.FC<{ file: FileWithMeta; index: number }> = ({
    file,
    index,
}) => {
    ...
    return (
        ...
        >
            ...
            <div className="flex-1 min-w-0">
                <p className="font-medium text-sm text-surface-content truncate">
                    {file.file.name}
                </p>
                <p className="font-mono text-xs text-muted-content">
