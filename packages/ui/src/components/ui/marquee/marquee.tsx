  ...
  (
    ...
    const getAnimationClass = () => {
      switch (loopMode) {
        ...
        case 'finite':
          return clsx('animate-marquee-scroll', '[animation-iteration-count:var(--loop-count)]');
        case 'single':
          return clsx(
    ...
    return (
      ...
      >
        ...
        >
          ...
          >
            {/* Original Content */}
            <div className="flex shrink-0 items-center justify-around gap-4 px-4">{children}</div>
