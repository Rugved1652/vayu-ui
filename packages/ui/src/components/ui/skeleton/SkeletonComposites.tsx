    ...
    <div className={`flex items-center gap-3 ${className}`} aria-hidden="true" {...props}>
      ...
      {showText && (
        <div className="flex-1">
          ...
          />
          {textLines > 1 && (
            <SkeletonItem variant="text" size="sm" width={subtitleWidth} animation={animation} />
          )}
        </div>
      )}
    </div>
        ...
        >
          ...
          <div className="flex-1">
            <SkeletonItem
              ...
              size={size}
            />
            <SkeletonItem variant="text" size="sm" width="40%" animation={animation} />
          </div>
        </div>
      ))}
    </div>
...
function SkeletonGroup({ children, className = '', spacing = 'md', ...props }: SkeletonGroupProps) {
