...
import { clampTimeSegment, convertTo12Hour, convertTo24Hour, isTimeDisabled, formatTimeValue } from "./utils";
...
const TimepickerTrigger = forwardRef<HTMLDivElement, { className?: string }>(
    ({ className }, ref) => {
        ...
        const commitTime = useCallback(
            ...
            [mode, rangePhase, value, onValueChange, showApplyButton, disabledTimes, disabledHours, minTime, maxTime, getDisplayHour, getDisplayMinute, getDisplayPeriod]
        );
