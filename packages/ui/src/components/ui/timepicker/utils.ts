...
export function isTimeDisabled(time: TimeValue, config: DisabledTimeConfig): boolean {
...
export function clampTimeSegment(raw: string, min: number, max: number): number {
