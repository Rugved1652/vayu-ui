...
export const PlayPauseButton = forwardRef<HTMLButtonElement, HTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => {
...
export const SkipBackwardButton = forwardRef<HTMLButtonElement, SkipButtonProps>(
...
export const SkipForwardButton = forwardRef<HTMLButtonElement, SkipButtonProps>(
  ({ seconds = 10, className, ...props }, ref) => {
...
export const TimeDisplay = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={clsx('text-white text-sm font-secondary font-medium', className)}
        {...props}
      >
...
export const FullscreenButton = forwardRef<HTMLButtonElement, HTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => {
...
export const SubtitlesButton = forwardRef<HTMLButtonElement, HTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ...
        className={clsx(VIDEO_BTN, showSubtitles && 'bg-white/20', className)}
        {...props}
      >
        <Subtitles className="w-5 h-5 text-white" aria-hidden="true" />
      </button>
    );
  },
);
...
export const DownloadButton = forwardRef<HTMLButtonElement, HTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => {
...
export const LoadingOverlay = forwardRef<HTMLDivElement, HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
...
export const CenterPlayButton = forwardRef<HTMLButtonElement, HTMLAttributes<HTMLButtonElement>>(
  ({ className, ...props }, ref) => {
    const { isPlaying, togglePlay } = useVideoPlayer();
    ...
    return (
      ...
      >
        <div className="w-20 h-20 rounded-full bg-white/90 flex items-center justify-center group-hover/center:bg-white transition-colors shadow-xl">
          <Play className="w-10 h-10 text-black ml-1" fill="currentColor" aria-hidden="true" />
        </div>
      </button>
    );
  },
